...
import { useReports } from '@/hooks/useAi';
              ...
              >
                <span
                  className={cn(
                    ...
                    r.kind === 'weekly' ? 'bg-brand/15 text-brand' : 'bg-blue-500/15 text-blue-500',
                  )}
                >
                ...
                <span className="min-w-0 flex-1">
                  ...
                  {r.structured?.summary && (
                    <span className="muted line-clamp-1 text-sm">{r.structured.summary}</span>
                  )}
                </span>
