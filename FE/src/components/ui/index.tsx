 ...
 *
 * ⚠️ Trước đây hàm này chỉ `join(' ')`, và đó là một cái bẫy nằm ở mọi component có
 * override class: `Input` mang sẵn `w-full`, truyền thêm `w-36` vào thì ra
 * `class="w-full ... w-36"` — hai lớp cùng tồn tại, `w-full` thắng, và ô input giãn hết cỡ
 * dù mã nguồn nói rõ là muốn 36. Không có lỗi nào được báo; chỉ có giao diện sai.
 *
