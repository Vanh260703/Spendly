...
export function CategoryForm({
  ...
  /**
   * Khởi tạo trực tiếp từ `editing` — KHÔNG sync qua `useEffect` + `setState`.
   *
   * `editing` chỉ đổi khi component này bị REMOUNT (`CategoriesPage` gắn `key` theo id đang
   * sửa), nên state ban đầu tính một lần lúc mount là đủ, không cần đồng bộ lại giữa các
   * lần render.
   */
