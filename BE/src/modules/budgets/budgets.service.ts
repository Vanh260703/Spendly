...
export class BudgetsService {
   ...
   * vượt sẽ biến ngân sách thành phần thưởng một chiều và mất tác dụng kiểm soát.
   */
   ...
   *
   * ⚠️ Luôn loại danh mục `isSystem` (giao dịch không thuộc chi tiêu thật của user), và
   * `SUM()` từ raw query trả về **chuỗi** nên phải `Number()`.
   */
